...
//		super();
	...
	public Vehiculo(String placa, String tjeta_prioridad, String cilindrada, String color, String num_motor,
			String num_chasis, Integer kitGlpSiNo, Integer estado, Integer idtipv, Integer idmarcv, Integer idTipSv,
			Integer idtipoMotorVeh, Integer idmodv, List<CombustibleVehiculo> combustibleVehiculo,
			TipoVehiculo tipoVehiculo, MarcaVehiculo marcaVehiculo, TipoServicioVehiculo tipoServicio,
			TipoMotorVehiculo tipoMotor, ModeloVehiculo modeloVehiculo, Poliza poliza) {
		super();
		this.placa = placa;
	...
	public String toString() {
		return "Vehiculo [placa=" + placa + ", tjeta_prioridad=" + tjeta_prioridad + ", cilindrada=" + cilindrada
				...
				+ kitGlpSiNo + ", estado=" + estado + ", idtipv=" + idtipv + ", idmarcv=" + idmarcv + ", idTipSv="
				+ idTipSv + ", idtipoMotorVeh=" + idtipoMotorVeh + ", idmodv=" + idmodv + ", combustibleVehiculo="
				+ combustibleVehiculo + ", tipoVehiculo=" + tipoVehiculo + ", marcaVehiculo=" + marcaVehiculo
