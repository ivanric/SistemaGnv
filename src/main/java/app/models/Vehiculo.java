...
//		super();
	...
	public Vehiculo(String placa, String tjeta_prioridad, String cilindrada, String color, String num_motor,
			String num_chasis, Integer kitGlpSiNo, Integer idtipv, Integer idmarcv, Integer idTipSv,
			...
			TipoMotorVehiculo tipoMotor, ModeloVehiculo modeloVehiculo) {
		super();
		this.placa = placa;
	...
	public String toString() {
		return "Vehiculo [placa=" + placa + ", tjeta_prioridad=" + tjeta_prioridad + ", cilindrada=" + cilindrada
				...
				+ kitGlpSiNo + ", idtipv=" + idtipv + ", idmarcv=" + idmarcv + ", idTipSv=" + idTipSv
				+ ", idtipoMotorVeh=" + idtipoMotorVeh + ", idmodv=" + idmodv + ", combustibleVehiculo="
