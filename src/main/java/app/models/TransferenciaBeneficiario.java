...
public class TransferenciaBeneficiario {
	protected Integer idtrasl,idsolt,idbenActual,idbenNuevo,aprobadoSiNo;
	...
	public TransferenciaBeneficiario(Integer idtrasl, Integer idsolt, Integer idbenActual, Integer idbenNuevo,
			Integer aprobadoSiNo, String fechaTraslado, String motivoTraslado, String login,
			Persona personaAnteriorBenf, Persona personaNuevoBenf, RegistroKit registroKit) {
		super();
	...
	public String toString() {
		return "TransferenciaBeneficiario [idtrasl=" + idtrasl + ", idsolt=" + idsolt + ", idbenActual=" + idbenActual
				+ ", idbenNuevo=" + idbenNuevo + ", aprobadoSiNo=" + aprobadoSiNo + ", fechaTraslado=" + fechaTraslado
				+ ", motivoTraslado=" + motivoTraslado + ", login=" + login + ", personaAnteriorBenf="
				+ personaAnteriorBenf + ", personaNuevoBenf=" + personaNuevoBenf + ", registroKit=" + registroKit + "]";
	}
