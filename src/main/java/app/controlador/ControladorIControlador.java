...
@RequestMapping({"/IContrato/"})
@Controller
public class ControladorIControlador {
	...
	public String gestion(HttpServletRequest request,Model m){
		...
		return "incumplimientoContrato/gestion";
	}
	...
	public String modal_add(HttpServletRequest request,Model m){
		...
		return "incumplimientoContrato/modal-adicionar";
	}
	...
	public String modal_ver(HttpServletRequest request,Model m){
		...
		return "incumplimientoContrato/modal-ver";
	}
}
